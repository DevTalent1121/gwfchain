...
import (
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/common/mclock"
...
// Service implements an GWFChain netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server       // Peer-to-peer server to retrieve networking infos
	eth    *eth.GoChain      // Full GWFChain service if monitoring a full node
	les    *les.LightGoChain // Light GWFChain service if monitoring a light node
