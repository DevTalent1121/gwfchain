...
Original Author Péter Szilágyi
...
The above is enough to validate a chain, but how can we update a dynamic list of signers. The answer is that we can repurposed the newly obsoleted miner field and the PoA obsoleted nonce field to create a voting protocol:
...
We repurposed the ethash header fields as follows:
