...
import (
	...
	gwfchain "github.com/NlaakStudiosLLC/gwfchain/v3"
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/common/math"
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/event"
...
func (b *SimulatedBackend) TransactionByHash(ctx context.Context, txHash common.Hash) (*types.Transaction, bool, error) {
	...
	return nil, false, gwfchain.NotFound
}
...
func (b *SimulatedBackend) CallContract(ctx context.Context, call gwfchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) PendingCallContract(ctx context.Context, call gwfchain.CallMsg) ([]byte, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) EstimateGas(ctx context.Context, call gwfchain.CallMsg) (uint64, error) {
	b.mu.Lock()
	defer b.mu.Unlock()
...
func (b *SimulatedBackend) callContract(ctx context.Context, call gwfchain.CallMsg, block *types.Block, statedb *state.StateDB) ([]byte, uint64, bool, error) {
...
func (b *SimulatedBackend) FilterLogs(ctx context.Context, query gwfchain.FilterQuery) ([]types.Log, error) {
...
func (b *SimulatedBackend) SubscribeFilterLogs(ctx context.Context, query gwfchain.FilterQuery, ch chan<- types.Log) (gwfchain.Subscription, error) {
