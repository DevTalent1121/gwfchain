...
func (mc *mockCaller) CallContract(ctx context.Context, call gwfchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call gwfchain.CallMsg) ([]byte, error) {
