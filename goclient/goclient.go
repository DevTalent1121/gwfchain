...
func (ec *Client) SyncProgress(ctx context.Context) (*gwfchain.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (gwfchain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q gwfchain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q gwfchain.FilterQuery, ch chan<- types.Log) (gwfchain.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q gwfchain.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg gwfchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg gwfchain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg gwfchain.CallMsg) (uint64, error) {
...
func toCallArg(msg gwfchain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
