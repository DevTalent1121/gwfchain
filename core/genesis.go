...
// DefaultGenesisBlock returns the GWFChain main net genesis block.
func DefaultGenesisBlock() *Genesis {
	...
	var extra = []byte("GWFChain")
	return &Genesis{
		Config:     params.MainnetChainConfig,
		Timestamp:  1630024073,
...
func DefaultGoChainGenesisBlock() *Genesis {
	allocAddr := common.HexToAddress("0xF75B6E2D2d69Da07f2940e239E25229350f8103f")
	alloc, ok := new(big.Int).SetString("1000000000000000000000000000", 10)
	if !ok {
		panic("failed to parse big.Int string")
...
// DeveloperGenesisBlock returns the 'gwfchain --dev' genesis block. Note, this must
...
// LocalGenesisBlock returns the 'gwfchain --local' genesis block.
