...
import (
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/internal/jsre/deps"
	"github.com/NlaakStudiosLLC/gwfchain/v3/internal/web3ext"
...
func (c *Console) Welcome() {
	message := "Welcome to the GWFChain JavaScript console!\n\n"
