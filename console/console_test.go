...
import (
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	// Create a networkless protocol stack and start an GWFChain service within
	...
	if err = stack.Register(func(sctx *node.ServiceContext) (node.Service, error) { return eth.New(sctx, ethConf) }); err != nil {
		t.Fatalf("failed to register GWFChain protocol: %v", err)
	}
