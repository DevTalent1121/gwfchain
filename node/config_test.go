...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gwfchain.ipc", false, filepath.Join(os.TempDir(), "gwfchain.ipc")},
		{"data", "gwfchain.ipc", false, "data/gwfchain.ipc"},
		{"data", "./gwfchain.ipc", false, "./gwfchain.ipc"},
		{"data", "/gwfchain.ipc", false, "/gwfchain.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gwfchain.ipc", true, `\\.\pipe\gwfchain.ipc`},
		{"data", "gwfchain.ipc", true, `\\.\pipe\gwfchain.ipc`},
		{"data", `\\.\pipe\gwfchain.ipc`, true, `\\.\pipe\gwfchain.ipc`},
	}
