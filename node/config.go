...
import (
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/accounts/external"
	"github.com/NlaakStudiosLLC/gwfchain/v3/accounts/keystore"
	"github.com/NlaakStudiosLLC/gwfchain/v3/accounts/scwallet"
	"github.com/NlaakStudiosLLC/gwfchain/v3/accounts/usbwallet"
...
func (c *Config) NodeName() string {
	name := c.name()
	// Backwards compatibility: previous versions used title-cased "GWFChain", keep that.
...
var isOldGoChainResource = map[string]bool{
	"chaindata":          true,
	"nodes":              true,
	"nodekey":            true,
...
func makeAccountManager(conf *Config) (*accounts.Manager, string, error) {
	...
	if keydir == "" {
		// There is no datadir.
		keydir, err = ioutil.TempDir("", "gwfchain-keystore")
		ephemeral = keydir
	}
