...
import (
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/common/fdlimit"
	"github.com/NlaakStudiosLLC/gwfchain/v3/consensus"
	"github.com/NlaakStudiosLLC/gwfchain/v3/consensus/clique"
	"github.com/NlaakStudiosLLC/gwfchain/v3/core"
	"github.com/NlaakStudiosLLC/gwfchain/v3/core/rawdb"
	"github.com/NlaakStudiosLLC/gwfchain/v3/core/state"
	"github.com/NlaakStudiosLLC/gwfchain/v3/core/vm"
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/eth/gasprice"
	"github.com/NlaakStudiosLLC/gwfchain/v3/ethdb"
	"github.com/NlaakStudiosLLC/gwfchain/v3/les"
	"github.com/NlaakStudiosLLC/gwfchain/v3/log"
	"github.com/NlaakStudiosLLC/gwfchain/v3/metrics"
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/p2p/netutil"
	"github.com/NlaakStudiosLLC/gwfchain/v3/params"
	whisper "github.com/NlaakStudiosLLC/gwfchain/v3/whisper/whisperv6"
...
// for GWFChain and returns half of the allowance to assign to the database.
...
// RegisterEthService adds an GWFChain client to the stack.
func RegisterEthService(ctx context.Context, stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the GWFChain service: %v", err)
	}
}
...
// RegisterNetStatsService configures the GWFChain Stats daemon and adds it to
// the given node.
func RegisterNetStatsService(stack *node.Node, cfg netstats.Config) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		...
		Fatalf("Failed to register the GWFChain Stats service: %v", err)
	}
}
