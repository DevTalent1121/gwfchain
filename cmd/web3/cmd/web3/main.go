...
import (
	...
	"github.com/NlaakStudiosLLC/gochain/gochain/v3/accounts/keystore"
...
func main() {
	...
	app.Commands = []cli.Command{
			...
			Subcommands: []cli.Command{
				...
				},
				{
					...
					Flags: []cli.Flag{
						...
						cli.StringFlag{
							Name:  "explorer-api",
							Usage: "Explorer API URL. Optional for GWFChain networks, which use `{testnet-}explorer.gochain.io` by default",
						},
						cli.StringFlag{
							Name:  "solc-version, c",
							Usage: "The version of the solc compiler(a tag of the ethereum/solc docker image)",
		...
		{
			Name:  "start",
			Usage: "Start a local GWFChain development node",
			Flags: []cli.Flag{
				cli.BoolTFlag{
					Name:  "detach, d",
