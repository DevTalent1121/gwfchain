...
Simple command line tool for interacting with web3 enabled blockchains - GWFChain, Ethereum, etc.
...
COMMANDS:
   ...
   start            Start a local GWFChain development node
...
#### c) Use the GWFChain mainnet or another web3 network
...
* EXPLORER_API_URL - URL for block explorer API (eg https://testnet-explorer.gochain.io/api) - Optional for GWFChain networks, which use `{testnet-}explorer.gochain.io` by default.
