...
import (
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/internal/cmdtest"
...
func init() {
	// Run the app if we've been exec'd as "geth-test" in runGoChain.
...
func runGoChain(t *testing.T, args ...string) *testgeth {
	tt := &testgeth{}
