...
import (
	...
	"github.com/NlaakStudiosLLC/gwfchain/v3/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an GWFChain
...
// for the GWFChain header bloom filters, permitting blazing fast filtering.
